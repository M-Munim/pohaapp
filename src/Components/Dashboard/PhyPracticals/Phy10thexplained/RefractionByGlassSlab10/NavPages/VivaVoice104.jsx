...
const VivaVoice104 = () => {
    return (
        <div className=" mt-5 pl-3">
            <p className="font-semibold text-dark text-xl my-4">1: A ray of light incident on one of the parallel faces of a rectangular glass slab, emerges out of the opposite parallel face
            </p>
            <ol className='pl-2 text-dark50 text-base'>
                <li className="option"><label><input type="radio" name="answer1" value="option1" /> <img className='inline-block pb-1' src={img1} alt="" /></label></li>
                <li className="option"><label><input type="radio" name="answer1" value="option2" /> <img className='inline-block pb-1' src={img2} alt="" /></label></li>
                <li className="option"><label><input type="radio" name="answer1" value="option3" /> <img className='inline-block pb-1' src={img3} alt="" /></label></li>
                <li className="option"><label><input type="radio" name="answer1" value="option4" /> <img className='inline-block' src={img4} alt="" /></label></li>
            </ol>
            ...
            <ol className='pl-2 text-dark50 text-base'>
                ...
                <li className="option"><label><input type="radio" name="answer9" value="option4" /> None of these</label></li>
            </ol>
