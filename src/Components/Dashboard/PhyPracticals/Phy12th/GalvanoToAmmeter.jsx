...
import galvanometertoammeter from "../../../../assets/galvanometer-to-ammeter.png"

const GalvanoToAmmeter = () => {
    return (
        <div className='w-64 h-60 bg-overviewWhite border-primaryGradient border-2 rounded-xl relative'>
            <div className="p-4">
                <img src={galvanometertoammeter} alt="" className='rounded-md' />
                <p className="font-semibold text-base text-dark50 mt-2">Conversion of Galvano-
                    meter to Ammeter</p>
            </div>
...
export default GalvanoToAmmeter