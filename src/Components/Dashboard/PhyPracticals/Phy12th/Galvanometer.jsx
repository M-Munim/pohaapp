...
import galvanometer from "../../../../assets/galvanometer.png"

const Galvanometer = () => {
  return (
    <div className='w-64 h-60 bg-overviewWhite border-primaryGradient border-2 rounded-xl relative'>
      <div className="p-4">
        <img src={galvanometer} alt="" className='rounded-md' />
        <p className="font-semibold text-base text-dark50 mt-2">Figure of Merit of a
          Galvanometer</p>
      </div>
