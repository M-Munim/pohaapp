...
import uvconcavemirror from "../../../../assets/uv-concave-mirror.png"

const UvConcave = () => {
    return (
        <div className='w-64 h-60 bg-overviewWhite border-primaryGradient border-2 rounded-xl relative'>
            <div className="p-4">
                <img src={uvconcavemirror} alt="" className='rounded-md' />
                <p className="font-semibold text-base text-dark50 mt-2">Concave Mirror-Focal
                    Length by u-v Method</p>
            </div>
