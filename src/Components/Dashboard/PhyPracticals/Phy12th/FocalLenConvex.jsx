...
import Focallengthconvexmirror from "../../../../assets/Focallength-convex-mirror.png"

const FocalLenConvex = () => {
    return (
        <div className='w-64 h-60 bg-overviewWhite border-primaryGradient border-2 rounded-xl relative'>
            <div className="p-4">
                <img src={Focallengthconvexmirror} alt="" className='rounded-md' />
                <p className="font-semibold text-base text-dark50 mt-2">Convex Mirror-Focal
                    Length</p>
            </div>
