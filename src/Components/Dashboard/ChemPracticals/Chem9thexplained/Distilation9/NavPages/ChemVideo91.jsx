    ...
    return (
        <div className="relative mr-auto pb-32 mt-5 pt-24 overflow-hidden">
            ...
            <div className="w-widthhh h-96 m-auto relative z-10 flex items-center justify-center">
                <iframe className='rounded-xl' width="100%" height="420" src="https://www.youtube.com/embed/wLLNGD9k57U" title="EXPERIMENT 15.1: Trace the magnetic field using a bar magnet." frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
            </div>
